...
-- Iscrizioni Torneo 3 (id da 41 a 50) - Simulazione 1a giornata giocata
...
-- Iscrizioni Torneo 4 (id da 51 a 60) - Torneo non ancora iniziato
INSERT INTO Squadra_Iscritta (id, torneo_id, squadra_id, giocate, vittorie, pareggi, sconfitte, punti) VALUES (51, 4, 11, 0, 0, 0, 0, 0);
INSERT INTO Squadra_Iscritta (id, torneo_id, squadra_id, giocate, vittorie, pareggi, sconfitte, punti) VALUES (52, 4, 12, 0, 0, 0, 0, 0);
INSERT INTO Squadra_Iscritta (id, torneo_id, squadra_id, giocate, vittorie, pareggi, sconfitte, punti) VALUES (53, 4, 13, 0, 0, 0, 0, 0);
INSERT INTO Squadra_Iscritta (id, torneo_id, squadra_id, giocate, vittorie, pareggi, sconfitte, punti) VALUES (54, 4, 14, 0, 0, 0, 0, 0);
INSERT INTO Squadra_Iscritta (id, torneo_id, squadra_id, giocate, vittorie, pareggi, sconfitte, punti) VALUES (55, 4, 15, 0, 0, 0, 0, 0);
INSERT INTO Squadra_Iscritta (id, torneo_id, squadra_id, giocate, vittorie, pareggi, sconfitte, punti) VALUES (56, 4, 16, 0, 0, 0, 0, 0);
INSERT INTO Squadra_Iscritta (id, torneo_id, squadra_id, giocate, vittorie, pareggi, sconfitte, punti) VALUES (57, 4, 17, 0, 0, 0, 0, 0);
INSERT INTO Squadra_Iscritta (id, torneo_id, squadra_id, giocate, vittorie, pareggi, sconfitte, punti) VALUES (58, 4, 18, 0, 0, 0, 0, 0);
INSERT INTO Squadra_Iscritta (id, torneo_id, squadra_id, giocate, vittorie, pareggi, sconfitte, punti) VALUES (59, 4, 19, 0, 0, 0, 0, 0);
INSERT INTO Squadra_Iscritta (id, torneo_id, squadra_id, giocate, vittorie, pareggi, sconfitte, punti) VALUES (60, 4, 20, 0, 0, 0, 0, 0);

-- Iscrizioni Torneo 5 (id da 61 a 70) - Torneo non ancora iniziato
...
-- Iscrizioni Torneo 6 (id da 71 a 80) - Torneo non ancora iniziato
...
-- Iscrizioni Torneo 7 (id da 81 a 90) - Torneo non ancora iniziato
...
-- Giocatori aggiuntivi (mantenendo le relazioni)
...
-- Torneo 1 (Torneo Estivo Roma 2026)
...
-- Torneo 2 (Coppa Italia Nazionale 2026)
INSERT INTO partita (id, data, ora, luogo, gol_casa, gol_trasferta, stato, squadra_casa_id, squadra_trasferta_id, arbitro_id, torneo_id) VALUES (8, '2026-07-26', '15:00:00', 'Bentegodi', 2, 1, 'TERMINATA', 28, 29, 1, 2);
INSERT INTO partita (id, data, ora, luogo, gol_casa, gol_trasferta, stato, squadra_casa_id, squadra_trasferta_id, arbitro_id, torneo_id) VALUES (9, '2026-07-28', '20:45:00', 'San Siro', 1, 0, 'TERMINATA', 31, 18, 3, 2);
INSERT INTO partita (id, data, ora, luogo, gol_casa, gol_trasferta, stato, squadra_casa_id, squadra_trasferta_id, arbitro_id, torneo_id) VALUES (10, '2026-07-29', '20:45:00', 'U-Power', 1, 0, 'SOSPESA', 17, 33, 4, 2);
INSERT INTO partita (id, data, ora, luogo, gol_casa, gol_trasferta, stato, squadra_casa_id, squadra_trasferta_id, arbitro_id, torneo_id) VALUES (11, '2026-07-28', '20:45:00', 'Castellani', 0, 3, 'TERMINATA', 34, 22, 3, 2);
INSERT INTO partita (id, data, ora, luogo, gol_casa, gol_trasferta, stato, squadra_casa_id, squadra_trasferta_id, arbitro_id, torneo_id) VALUES (12, '2026-07-29', '15:00:00', 'Stirpe', 1, 1, 'IN_CORSO', 35, 36, 4, 2);
INSERT INTO partita (id, data, ora, luogo, gol_casa, gol_trasferta, stato, squadra_casa_id, squadra_trasferta_id, arbitro_id, torneo_id) VALUES (13, '2026-07-29', '20:45:00', 'Mapei', 2, 1, 'TERMINATA', 37, 21, 3, 2);
INSERT INTO partita (id, data, ora, luogo, gol_casa, gol_trasferta, stato, squadra_casa_id, squadra_trasferta_id, arbitro_id, torneo_id) VALUES (15, '2026-07-29', '18:00:00', 'Penzo', 0, 0, 'IN_CORSO', 39, 40, 3, 2);
INSERT INTO partita (id, data, ora, luogo, gol_casa, gol_trasferta, stato, squadra_casa_id, squadra_trasferta_id, arbitro_id, torneo_id) VALUES (16, '2026-07-26', '18:00:00', 'Olimpico', 0, 0, 'IN_CORSO', 20, 23, 4, 2);
INSERT INTO partita (id, data, ora, luogo, gol_casa, gol_trasferta, stato, squadra_casa_id, squadra_trasferta_id, arbitro_id, torneo_id) VALUES (17, '2026-07-30', '20:45:00', 'Maradona', 0, 0, 'PROGRAMMATA', 22, 19, 3, 2);
...
UPDATE Squadra_Iscritta SET giocate=0, vittorie=0, pareggi=0, sconfitte=0, punti=0;
UPDATE Squadra_Iscritta SET giocate=1, vittorie=1, pareggi=0, sconfitte=0, punti=3 WHERE id=1;
UPDATE Squadra_Iscritta SET giocate=1, vittorie=0, pareggi=0, sconfitte=1, punti=0 WHERE id=2;
