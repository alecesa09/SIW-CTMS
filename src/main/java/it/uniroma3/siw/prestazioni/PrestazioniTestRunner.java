...
public class PrestazioniTestRunner implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        ...
        Torneo torneoBase = torneoRepository.findByIdWithIscrizioni(1L);
		...
		*/
        ...
        Torneo torneoJoin = torneoRepository.findByIdWithSquadre(1L);
        List<SquadraIscritta> iscrizioni = torneoJoin.getIscrizioni();
        for (SquadraIscritta iscrizione : iscrizioni) {
             iscrizione.getSquadra().getNome();
        }
        
        stopWatchJoin.stop();
        System.out.println("Tempo impiegato (JOIN FETCH): " + stopWatchJoin.getTotalTimeSeconds() + " secondi");
